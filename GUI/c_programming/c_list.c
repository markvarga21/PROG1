...
int main()
{
	...
	push_back(names, (struct Link*)make_name("Aladar"));
	push_back(names, (struct Link*)make_name("Adam"));
	push_back(names, (struct Link*)make_name("Lajos"));
	push_back(names, (struct Link*)make_name("Jakab"));
	push_back(names, (struct Link*)make_name("Mark"));
	push_back(names, (struct Link*)make_name("Janos"));
	push_back(names, (struct Link*)make_name("Balint"));
